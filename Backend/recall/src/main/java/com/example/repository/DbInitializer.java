...
public class DbInitializer {
    ...
    public void init() {
        ...
        User admin = userRepository.save(
                new User("admin123", "admin@ucll.be", "Admin", "User", passwordEncoder.encode("password")));

        User john = userRepository.save(
                new User("johndoe", "john.doe@email.com", "John", "Doe", passwordEncoder.encode("password123")));

        User jane = userRepository.save(
                new User("janesmith", "jane.smith@email.com", "Jane", "Smith", passwordEncoder.encode("password123")));

        User mike = userRepository.save(
                new User("mikeross", "mike.ross@email.com", "Mike", "Ross", passwordEncoder.encode("password123")));

        User emily = userRepository.save(
                new User("emilychen", "emily.chen@email.com", "Emily", "Chen", passwordEncoder.encode("password123")));

        User david = userRepository.save(
                new User("davidlee", "david.lee@email.com", "David", "Lee", passwordEncoder.encode("password123")));
        ...
        birthdayParty.setUsernames(Arrays.asList("johndoe", "janesmith", "mikeross", "emilychen"));
        ...
        graduation.setUsernames(Arrays.asList("admin123", "johndoe", "janesmith", "davidlee"));
        ...
        wedding.setUsernames(Arrays.asList("janesmith", "mikeross", "emilychen", "davidlee"));
        ...
        concert.setUsernames(Arrays.asList("johndoe", "mikeross", "emilychen"));
        ...
        conference.setUsernames(Arrays.asList("admin123", "johndoe", "davidlee"));
        ...
        reunion.setUsernames(Arrays.asList("janesmith", "mikeross", "emilychen", "davidlee"));
