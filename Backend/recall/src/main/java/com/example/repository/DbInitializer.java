...
public class DbInitializer {
        ...
        public void init() {
                ...
                User jane = userRepository
                                .save(new User("jane_smith", "jane@example.com", "Jane", "Smith", "password456"));
                User bob = userRepository
                                .save(new User("bob_wilson", "bob@example.com", "Bob", "Wilson", "password789"));
                User alice = userRepository
                                .save(new User("alice_brown", "alice@example.com", "Alice", "Brown", "password321"));
                ...
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1530587191325-3db32d826c18",
                                summerPicnic, "summer,picnic,friends,outdoor"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1555939594-58d7cb561ad1",
                                summerPicnic,
                                "food,healthy,fresh"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1506905925346-21bda4d32df4",
                                summerPicnic, "nature,park,trees"));

                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1612872087720-bb876e2e67d1",
                                beachParty, "beach,volleyball,sports,fun"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1519046904884-53103b34b206",
                                beachParty, "beach,ocean,sunset"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1502933691298-84fc14542831",
                                beachParty, "tournament,action,competition"));

                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1512389142860-9c449e58a543",
                                christmasGala, "christmas,party,celebration,elegant"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1482575832494-771f74bf6857",
                                christmasGala, "decorations,lights,festive"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1481627834876-b7833e8f5570",
                                christmasGala, "dinner,gala,formal"));

                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1530103862676-de8c9debad1d",
                                birthdayBash, "birthday,celebration,party,cake"));
                pictureRepository.save(new Picture("https://images.unsplash.com/photo-1464366400600-7168b8af9bc3",
